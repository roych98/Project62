...
public class PetLootHandler extends AbstractMaplePacketHandler {
    ...
    public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
		...
		if (mapitem.getDropper() == c.getPlayer()) {
                ...
                if (mapitem.getMeso() > 0 && (c.getPlayer().getInventory(MapleInventoryType.EQUIPPED).findById(1812000) != null)) {
                    ...
                    } else if (c.getPlayer().getInventory(MapleInventoryType.EQUIPPED).findById(1812000) != null) { //Evil hax until I find the right packet - Ramon
