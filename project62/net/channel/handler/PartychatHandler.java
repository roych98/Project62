            ...
            if (c.getPlayer().getWatcher() != null) {
                switch (type) {
                    case 0:
                        ...
                        FilePrinter.printError(FilePrinter.SPYCHAT + "SPYCHAT" + ".txt","[" + c.getPlayer().getName() + " Buddy] : " + chattext + "\n");
                        break;
                    case 1:
                        c.getPlayer().getWatcher().dropMessage("[" + c.getPlayer().getName() + " Party] : " + chattext);
                        FilePrinter.printError(FilePrinter.SPYCHAT + "SPYCHAT" + ".txt","[" + c.getPlayer().getName() + " Party] : " + chattext + "\n");
                        break;
                    case 2:
                        c.getPlayer().getWatcher().dropMessage("[" + c.getPlayer().getName() + " Guild] : " + chattext);
                        FilePrinter.printError(FilePrinter.SPYCHAT + "SPYCHAT" + ".txt","[" + c.getPlayer().getName() + " Guild] : " + chattext + "\n");
                        break;
                    case 3:
                        c.getPlayer().getWatcher().dropMessage("[" + c.getPlayer().getName() + " Alliance] : " + chattext);
                        FilePrinter.printError(FilePrinter.SPYCHAT + "SPYCHAT" + ".txt","[" + c.getPlayer().getName() + " Alliance] : " + chattext + "\n");
                        break;
                }
            }  
        }
