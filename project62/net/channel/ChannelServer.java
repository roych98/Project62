...
public class ChannelServer implements Runnable, ChannelServerMBean {
    ...
    public ScheduledFuture<?> hottimeTimer;
    public String oldServerMessage;
            ...
            synchronized (cwi) {
                ...
                synchronized (wci) {
                    ...
                    try {
                        ...
                        questMultiplyer = Integer.parseInt(props.getProperty("net.sf.odinms.world.questMultiplyer"));
                        ...
                        oldServerMessage = serverMessage;
    ...
    public int getQuestMultiplyer() {
        return this.questMultiplyer;
    }
}