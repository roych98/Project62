...
import net.sf.odinms.net.channel.handler.damageHandlers.*;
import net.sf.odinms.net.channel.handler.itemHandlers.*;
import net.sf.odinms.net.channel.handler.npcHandlers.*;
import net.sf.odinms.net.channel.handler.useHandlers.*;      
...
public final class PacketProcessor {
    ...
    public void registerHandler(RecvPacketOpcode code, MaplePacketHandler handler) {
        try {
            ...
            System.out.println("Handlers length: " + handlers.length + " REcvPacketCode " + code.getValue());
    ...
    public void reset(Mode mode) {
        ...
        if (mode == Mode.LOGINSERVER) {
            ...
            //registerHandler(RecvPacketOpcode.SELECT_GENDER, new SelectGenderHandler()); 
            ...
            registerHandler(RecvPacketOpcode.NPC_TALK, new TalkHandler());//
            registerHandler(RecvPacketOpcode.NPC_TALK_MORE, new MoreTalkHandler());//
            registerHandler(RecvPacketOpcode.QUEST_ACTION, new QuestActionHandler());
            registerHandler(RecvPacketOpcode.NPC_SHOP, new ShopHandler());//
            registerHandler(RecvPacketOpcode.ITEM_SORT, new SortHandler());//
            registerHandler(RecvPacketOpcode.ITEM_MOVE, new MoveItemHandler());//
            ...
            registerHandler(RecvPacketOpcode.CLOSE_RANGE_ATTACK, new MeleeHandler());//
            registerHandler(RecvPacketOpcode.RANGED_ATTACK, new RangedHandler());//
            registerHandler(RecvPacketOpcode.MAGIC_ATTACK, new MagicHandler());//
            ...
            registerHandler(RecvPacketOpcode.USE_CASH_ITEM, new CashItemHandler());//
            registerHandler(RecvPacketOpcode.USE_ITEM, new ItemHandler());//
            registerHandler(RecvPacketOpcode.USE_RETURN_SCROLL, new ItemHandler());//
            registerHandler(RecvPacketOpcode.USE_UPGRADE_SCROLL, new ScrollHandler());
            registerHandler(RecvPacketOpcode.USE_SUMMON_BAG, new SummonBag());//
            ...
            registerHandler(RecvPacketOpcode.ITEM_PICKUP, new PickupItemHandler());//
            ...
            registerHandler(RecvPacketOpcode.SUMMON_ATTACK, new SummonHandler());//
            registerHandler(RecvPacketOpcode.BUDDYLIST_MODIFY, new BuddylistModifyHandler());
            registerHandler(RecvPacketOpcode.USE_ITEMEFFECT, new ItemEffectHandler());//
            registerHandler(RecvPacketOpcode.USE_CHAIR, new ChairHandler());//
            ...
            registerHandler(RecvPacketOpcode.NPC_ACTION, new AnimationHandler());//
            ...
            registerHandler(RecvPacketOpcode.USE_CATCH_ITEM, new CatchItemHandler());//
            ...
            registerHandler(RecvPacketOpcode.ENERGY_ORB_ATTACK, new EnergyHandler());//
            registerHandler(RecvPacketOpcode.USE_SOLOMAN_ITEM, new SolomonHandler());//
            ...
            registerHandler(RecvPacketOpcode.DEBUG, new DebugHandler());
        } else {
