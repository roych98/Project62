        ...
        try {
            ...
            if (iv == null || NPCScriptManager.getInstance() == null) {
                if (iv == null) {
                    ...
                    FilePrinter.printError(FilePrinter.NPC + npc + ".txt", "NPC is broken, needs to be fixed. ID " + npc + "\n");
                }
                cm.dispose();
                return;
            }
            ...
            FilePrinter.printError(FilePrinter.NPCe + npc + ".txt", "NPC threw an error. " + npc + "\nThe error was " + e.getCause() + "\n");
            dispose(c);
            cms.remove(c);
        }
    }
